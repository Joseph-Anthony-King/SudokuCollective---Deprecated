...
export const getActivateAdminPrivilegesEnpoint = `${getAppEnpoint}/activateAdminPrivileges`;
export const getDeactivateAdminPrivilegesEnpoint = `${getAppEnpoint}/deactivateAdminPrivileges`;
