...
namespace SudokuApp.SudokuUtilities {
    public static class SolutionGenerator {
        ...
        public static List<int> Generate() {
            ...
            do {
                ...
                List<int> firstRow = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
                List<int> secondRow = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
                List<int> thirdRow = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
                List<int> fourthRow = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
                List<int> fifthRow = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
                List<int> sixthRow = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
                List<int> seventhRow = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
                List<int> eighthRow = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
                List<int> ninthRow = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };

                List<int> firstColumn = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
                List<int> secondColumn = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
                List<int> thirdColumn = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
                List<int> fourthColumn = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
                List<int> fifthColumn = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
                List<int> sixthColumn = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
                List<int> seventhColumn = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
                List<int> eighthColumn = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };
                List<int> ninthColumn = new List<int>() { 1, 2, 3, 4, 5, 6, 7, 8, 9 };

                AppExtensions.AppExtensions.Shuffle(firstRow);
                ...
                if (maxIterationsReached == false) {
                    AddRowsToSudokuMatrix(ref result, ref firstRow, ref secondRow, ref thirdRow, ref fourthRow, ref fifthRow,
        ...
        private static void SetSecondRow(int MAX_ITERATIONS, ref int iterations, ref bool maxIterationsReached, ref List<int> _secondRow, List<int> _firstRow) {
            do {
                AppExtensions.AppExtensions.Shuffle(_secondRow);
                ++iterations;
        ...
        private static void SetThirdRow(int MAX_ITERATIONS, ref int iterations, ref bool maxIterationsReached, ref List<int> thirdRow, List<int> firstRow, List<int> secondRow) {
            do {
                AppExtensions.AppExtensions.Shuffle(thirdRow);
                ++iterations;
        ...
        private static void SetFourthRow(int MAX_ITERATIONS, ref int iterations, ref bool maxIterationsReached, ref List<int> fourthRow,
            ...
            do {
                AppExtensions.AppExtensions.Shuffle(fourthRow);
                ++iterations;
        ...
        private static void SetFifthRow(int MAX_ITERATIONS, ref int iterations, ref bool maxIterationsReached, ref List<int> fifthRow,
            ...
            do {
                AppExtensions.AppExtensions.Shuffle(fifthRow);
                ++iterations;
        ...
        private static void SetSixthRow(int MAX_ITERATIONS, ref int iterations, ref bool maxIterationsReached, ref List<int> sixthRow,
            ...
            do {
                AppExtensions.AppExtensions.Shuffle(sixthRow);
                ++iterations;
        ...
        private static void SetSeventhRow(int MAX_ITERATIONS, ref int iterations, ref bool maxIterationsReached, ref List<int> seventhRow,
            ...
            ref List<int> ninthColumn) {
            do {
                AppExtensions.AppExtensions.Shuffle(seventhRow);
                ++iterations;
        ...
        private static void SetEighthRow(int MAX_ITERATIONS, ref int iterations, ref bool maxIterationsReached, ref List<int> eighthRow,
            ...
            do {
                AppExtensions.AppExtensions.Shuffle(eighthRow);
                ++iterations;
        ...
        private static void SetNinthRow(int MAX_ITERATIONS, ref int iterations, ref bool maxIterationsReached, ref List<int> ninthRow,
            ...
            do {
                AppExtensions.AppExtensions.Shuffle(ninthRow);
                ++iterations;
        ...
        private static void AddRowsToSudokuMatrix(ref List<int> sudokuMatrix, ref List<int> firstRow, ref List<int> secondRow,
            ...
            sudokuMatrix.AddRange(firstRow);
            sudokuMatrix.AddRange(secondRow);
            sudokuMatrix.AddRange(thirdRow);
            sudokuMatrix.AddRange(fourthRow);
            sudokuMatrix.AddRange(fifthRow);
            sudokuMatrix.AddRange(sixthRow);
            sudokuMatrix.AddRange(seventhRow);
            sudokuMatrix.AddRange(eighthRow);
            sudokuMatrix.AddRange(ninthRow);
        }
    }
}
