...
namespace SudokuCollective.Data.Services
{
    public class SolutionsService : ISolutionsService
    {
            ...
            try
            {
                ...
                if (solvedSolutions.Count > 0)
                {
                    solutions = (solvedSolutions
                        ...
                        .ToList()).ConvertAll(s => s as ISudokuSolution);
                }
                    ...
                    if (sudokuSolver.IsValid())
                    {
                        ...
                        foreach (var solution in solutions)
                        {
                            if (solution.ToString().Equals(result.ToString()))
                            {
                                ...
                                result = (SudokuSolution)solution;
                            }
                        }
        ...
        public async Task<ISolutionResult> Generate()
        {
            ...
            _context.SudokuSolutions.Add((SudokuSolution)solutionTaskResult.Solution);
            await _context.SaveChangesAsync();
